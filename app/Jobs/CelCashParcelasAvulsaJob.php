...
class CelCashParcelasAvulsaJob implements ShouldQueue, ShouldBeUnique
{
    ...
    {
        return 'celcash_parcelas_avulsa_' . $this->id;
    }
    ...
    public function handle()
    {
        try {
            ...
            $return = CelCash::CelCashParcelasAvulsa($this->id);
